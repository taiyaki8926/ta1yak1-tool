...
_sage_const_0 = Integer(0); _sage_const_2 = Integer(2); _sage_const_3 = Integer(3); _sage_const_1 = Integer(1); _sage_const_4 = Integer(4); _sage_const_8 = Integer(8); _sage_const_27 = Integer(27); _sage_const_9 = Integer(9); _sage_const_413400541209677581972773119133520959089878607131 = Integer(413400541209677581972773119133520959089878607131); _sage_const_24 = Integer(24); _sage_const_12 = Integer(12)
def help():
    print("---Tool list---")
...
def pohlig(p, A, B, P:list, Q:list, bound=_sage_const_0 ):
    EC = EllipticCurve(GF(p), [A, B])
    _P = EC((P[_sage_const_0 ], P[_sage_const_1 ]))
    _Q = EC((Q[_sage_const_0 ], Q[_sage_const_1 ]))
    order = EC.order()
...
def singular(p, A:list, P, Q):
    def calc_trans(p, A):
        ...
        x = _sage_const_413400541209677581972773119133520959089878607131 
